...
export const LEVELS: readonly LevelSpec[] = [
  ...
  { level: 12,  name: 'BLOKAZ SOVEREIGN', accent: '#ffd51f', targets: { games: 120, tournaments: 54, purchases: 20, points: 260_000}, reward: '5× of every power-up', cashMilestone: true },
]
